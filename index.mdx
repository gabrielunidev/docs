---
title: "Introdução"
description: "Seja bem-vindo a documentação da plataforma de integração Uniwoot."
---

## Como configurar

Acesse a documentaçao completa de como configurar sua primeira instancia no guia abaixo:

<Card title="Configuraçao Inicial" icon="rocket" horizontal={false} href="/quickstart">
  Criando sua primeira instancia.
</Card>
